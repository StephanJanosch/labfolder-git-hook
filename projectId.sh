...
#more on the version with extension,Lap on the sphere with analytical initial condition and extension of the Lap,jupyter notebooks to plot scalar and vectorial quantities of the open surface benchma